...
namespace App\Models {
    ...
    /**
     * App\Models\DonneesEpidemiologiques
     *
     * @property-read \App\Models\Pandemie $pandemie
     * @property-read \App\Models\Pays $pays
     * @property-read \App\Models\Source $source
     * @method static \Illuminate\Database\Eloquent\Builder|DonneesEpidemiologiques newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|DonneesEpidemiologiques newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|DonneesEpidemiologiques query()
     ...
     */
    class DonneesEpidemiologiques extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property date|null $date_fin
     * @property date $date_debut
     * @property string $virus
     * @property string $nom_pandemie
     * @property bigint(20) unsigned $id_pandemie
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\DonneesEpidemiologiques> $donneesEpidemiologiques
     * @property-read int|null $donneesEpidemiologiques_count
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereIdPandemie($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereNomPandemie($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereVirus($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereDateDebut($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereDateFin($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Pandemie query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Pandemie extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int(11)|null $dimension
     * @property int(11)|null $population
     * @property string $code_iso
     * @property string $nom_pays
     * @property bigint(20) unsigned $id_pays
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\DonneesEpidemiologiques> $donneesEpidemiologiques
     * @property-read int|null $donneesEpidemiologiques_count
     * @method static \Illuminate\Database\Eloquent\Builder|Pays whereIdPays($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pays whereNomPays($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pays whereCodeIso($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pays wherePopulation($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Pays whereDimension($value)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Pays extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
    ...
    /**
     * App\Models\StatsPandemie
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int(11)|null $cas_actifs
     * @property int(11)|null $nouveaux_gueris
     * @property int(11)|null $nouveaux_deces
     * @property int(11)|null $nouveaux_cas
     * @property date $date
     * @property bigint(20) unsigned $id_pays
     * @property bigint(20) unsigned $id_pandemie
     * @property bigint(20) unsigned $id_stat
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereIdStat($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereIdPandemie($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereIdPays($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereNouveauxCas($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereNouveauxDeces($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereNouveauxGueris($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereCasActifs($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|StatsPandemie query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class StatsPandemie extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
